            ...
            <div className="px-8 py-5 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
                <div>
                    <h2 className="text-lg font-bold text-slate-800">
                        {initialData ? 'Edit Medication Order' : 'New Prescription Record'}
                    </h2>
                    <p className="text-xs text-slate-500 mt-1">Authorize pharmaceutical issuance and dosing instructions</p>
                </div>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-7">
                ...
                <div className="space-y-6">
                    ...
                    <div className={`grid grid-cols-1 ${userRole === 'admin' ? 'md:grid-cols-2' : ''} gap-7`}>
                        ...
                        {userRole === 'admin' && (
                            <div className="space-y-1.5 focus-within:text-[#556ee6] transition-colors">
                                <label className="text-sm font-semibold text-slate-600 ml-0.5">Prescribing Physician</label>
                                <div className="relative group">
                                    <select
                                        className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-300 rounded-lg text-sm shadow-sm focus:bg-white focus:ring-2 focus:ring-[#556ee6]/20 focus:border-[#556ee6] outline-none transition-all text-slate-800 appearance-none"
                ...
                {/* --- MEDICATION --- */}
                <div className="space-y-6">
                    <h4 className="text-sm font-bold text-slate-800 border-l-4 border-[#556ee6] pl-3">Medication Details</h4>
                    <div className="space-y-1.5 focus-within:text-[#556ee6] transition-colors">
                        <label className="text-sm font-semibold text-slate-600 ml-0.5">Medication Name & Concentration</label>
                        <div className="relative group">
                            <input
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
                        <div className="space-y-1.5 focus-within:text-[#556ee6] transition-colors">
                            <label className="text-sm font-semibold text-slate-600 ml-0.5">Dosage</label>
                            <input
                                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-lg text-sm shadow-sm focus:bg-white focus:ring-2 focus:ring-[#556ee6]/20 focus:border-[#556ee6] outline-none transition-all text-slate-800 placeholder:text-slate-400"
                        ...
                        <div className="space-y-1.5 focus-within:text-[#556ee6] transition-colors">
                            <label className="text-sm font-semibold text-slate-600 ml-0.5">Frequency</label>
                            <input
                                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-lg text-sm shadow-sm focus:bg-white focus:ring-2 focus:ring-[#556ee6]/20 focus:border-[#556ee6] outline-none transition-all text-slate-800 placeholder:text-slate-400"
                        ...
                        <div className="space-y-1.5 focus-within:text-[#556ee6] transition-colors">
                            <label className="text-sm font-semibold text-slate-600 ml-0.5">Duration</label>
                            <input
                                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-lg text-sm shadow-sm focus:bg-white focus:ring-2 focus:ring-[#556ee6]/20 focus:border-[#556ee6] outline-none transition-all text-slate-800 placeholder:text-slate-400"
                ...
                <div className="flex flex-col-reverse sm:flex-row justify-between items-center gap-4 pt-4 border-t border-slate-100 mt-6 font-sans">
                    ...
                    >
                        ...
                        {initialData ? 'Update Order' : 'Save Prescription'}
                    </button>
                </div>
            </form>
        </div>
